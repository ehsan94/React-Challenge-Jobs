...
const JobItem = ({job: {_id, title, city, employer},hidden, toggleModalHidden , setCurrentUser, history, setCurrentJobDetail}) =>   
   { 
    
   
     return(
       <div className="job-item"   onClick={() => {
        history.push("/detail");
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(JobItem));
